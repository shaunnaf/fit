...
int main(void) {
  int number_flat_new, number_flat, entrance, floor, max_floor, flats_on_floor,
      curr_floor, curr_entrance;
  ...
  if (r == 0) {
    ...
    flats_on_floor =
        (int)((float)number_flat / (max_floor * (entrance - 1) + floor)) + 1;
  }
  ...
  if (r == 0) {
    ...
    curr_entrance =
        (int)(float)number_flat_new / (flats_on_floor * max_floor) + 1;
  }
