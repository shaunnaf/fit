...
void compare(int count_a, int *array_numbers_a, int *array_numbers_b, int *array_answer, int *count_answer);
        ...
        if (error != 1)
        {
            ...
            if (error != 1)
            {
                ...
                if (error != 1)
                {
                    ...
                    compare(count_a, array_numbers_a, array_numbers_b, array_answer, &count_answer);
...
void reading_numbers(int *array_numbers, int count, int *error)
{
    ...
    {
        if (scanf("%d", &array_numbers[i]) != 1 || array_numbers[i] > 100000 || array_numbers[i] < 0)
        {
            *error = 1;
            break;
        }
